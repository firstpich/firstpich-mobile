...
const Create = () => {
  ...
  return (
    <SafeAreaView
      ...
      <ScrollView style={tailwind("flex-grow px-4 py-4")}>
        <Text
          style={tailwind("font-mon-regular text-white text-lg text-left ")}>
          ...
          cupidatat incididunt do dolore id. Culpa commodo fugiat commodo ea
          ...
          consequat excepteur tempor qui anim et exercitation consequat.
        </Text>
      </ScrollView>
